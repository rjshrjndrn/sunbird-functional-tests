...
public class UnblockUserTest extends BaseCitrusTestRunner {
    ...
    public Object[][] UnblockUserFailureDataProvider() {
        ...
        return new Object[][]{
                new Object[]{
                        TEST_UNBLOCK_USER_FAILURE_WITHOUT_ACCESS_TOKEN, false, HttpStatus.UNAUTHORIZED
                },
                new Object[]{
                        TEST_UNBLOCK_USER_FAILURE_WITH_INVALID_USERID, true, HttpStatus.NOT_FOUND
                },
        };
    }
    ...
    public Object[][] blockUserSuccessDataProvider() {
        ...
        return new Object[][]{
                new Object[]{
                        TEST_UNBLOCK_USER_SUCCESS_WITH_VALID_USERID, true, HttpStatus.OK
                },
