...
public class AddUserSkillTest extends BaseCitrusTestRunner {
	...
	public static final String BT_TEST_NAME_CREATE_USER_SUCCESS =
	...
	public Object[][] addUserSkillSuccessDataProvider() {
		...
		return new Object[][] {
			new Object[] {
					TEST_NAME_ADD_USER_SKILL_SUCCESS_WITH_VALID_USER_ID, true, HttpStatus.OK
			},
	...
	public void testAddUserSkillSuccess(
		...
		/*if(testName.equalsIgnoreCase(TEST_NAME_ADD_USER_SKILL_SUCCESS_WITH_VALID_USER_ID)) {
