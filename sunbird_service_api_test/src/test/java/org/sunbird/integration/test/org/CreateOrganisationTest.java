...
public class CreateOrganisationTest extends BaseCitrusTest {
	...
	public static final String TEST_NAME_CREATE_SUB_ORG_WITHOUT_ACCESS_TOKEN = "testCreateSubOrgWithoutAccessToken";
	...
	public Object[][] createFailureOrgDataProvider() {
		...
		return new Object[][] {
			...
			new Object[] {
					TEST_NAME_CREATE_SUB_ORG_FAILURE_WITH_INVALID_LOCATION_CODE
			},
			new Object[] {
					TEST_NAME_CREATE_SUB_ORG_FAILURE_WITH_INVALID_CHANNEL
			},
			new Object[] {
